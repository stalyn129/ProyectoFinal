 ...
 * @author alexa
 */
public class Responder_Test_represent__1 extends javax.swing.JFrame {
     ...
     */
    public Responder_Test_represent__1() {
        initComponents();
        ocultarColumna();
    ...
    private void initComponents() {
        ...
        jPanel3.add(txt_pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 540, -1));
        ...
        jPanel3.add(Ingresar_respuesta, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 360, 20));
    ...
    private void btnMinimizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMinimizar1ActionPerformed
        this.setState(Responder_Test_represent__1.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Responder_Test_represent__1().setVisible(true);
            }
        });
    }
