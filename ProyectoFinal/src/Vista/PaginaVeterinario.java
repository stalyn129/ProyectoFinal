 ...
 * @author Jhony
 */
public class PaginaVeterinario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtespecialidadv = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jPanel1.add(txtnombrev, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, 230, -1));
        jPanel1.add(txtdireccionv, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 90, 230, -1));
        jPanel1.add(txttelefonov, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, 230, -1));
        jPanel1.add(txtemailv, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 230, -1));

        btnaceptarc.setText("Guardar");
        jPanel1.add(btnaceptarc, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 260, -1, -1));
        ...
        jPanel1.add(txtespecialidadv, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 210, 230, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaginaVeterinario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaginaVeterinario().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtespecialidadv;
